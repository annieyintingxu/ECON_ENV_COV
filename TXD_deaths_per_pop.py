...
TXD_df = pd.read_csv('/Users/Dino-Sunlight/Desktop/COVIDeeDesktop/Texas COVID-19 Fatality Count Data by County 6_15_20.csv') #loads data
...
for row in TXD_df.itertuples(): #this line: names each row as an index...??? below: calculates and stores the total and per capita for each row in the dataframe. Can I just use "JHU_df"??
...
calculated_df.to_csv('TXD_Calculated.csv') #I want to name by date somehow (ugh gotta extract from original csv)
